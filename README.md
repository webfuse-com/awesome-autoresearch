...
- [AndrewK404/autoresearch-v2](https://github.com/AndrewK404/autoresearch-v2) ![GitHub stars](https://img.shields.io/github/stars/AndrewK404/autoresearch-v2?style=social) - Agentic skill for autonomous optimization with a frozen task contract, scalar-metric keep/discard loop, async sub-agents, and research-only mode.
