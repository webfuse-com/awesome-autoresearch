...
- [P2PCLAW](https://github.com/Agnuxo1/p2pclaw) ![GitHub stars](https://img.shields.io/github/stars/Agnuxo1/p2pclaw?style=social) - **Decentralized peer-reviewed science network** — combines P2P collaboration, Lean 4 formal verification, multi-LLM tribunal scoring (17 judges), AI research agents, and community-driven scientific publishing with cryptographic identity and IPFS persistence.
